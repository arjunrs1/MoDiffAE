...
cwd = os.getcwd()
train_path = os.path.join(cwd, 'learning_curve_plots',
                          'semantic_generator_based_on_modiffae_b0372_model000700000',
                          'train_mae.json')
train_loss = json.load(open(train_path, 'r'))
...
plt.plot(train_loss_steps, train_loss_values)
plt.show()
