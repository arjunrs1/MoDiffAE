...
base_dir = os.path.join(cwd, 'save', 'rot_6d_karate',
                        'semantic_regressor_based_on_modiffae_b0372_model000700000', 'evaluation')
save_path = os.path.join(base_dir, 'loss')

train_scores_path = os.path.join(base_dir, 'loss_data', 'train_loss_regressor_b0372.json')
validation_scores_path = os.path.join(base_dir, 'loss_data', 'validation_loss_regressor_b0372.json')

train_loss = json.load(open(train_scores_path, 'r'))
validation_loss = json.load(open(validation_scores_path, 'r'))

overview_path = os.path.join(base_dir, 'regression_best_results_overview_b0372.json')
...
best_val_loss_step = np.argmin(validation_loss_values) * 500
