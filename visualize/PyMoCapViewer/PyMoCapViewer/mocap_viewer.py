...
class MoCapViewer(object):
    ...
    def __init__(
        ...
        #c = self.__colors.GetColor4d(bg_color)
        #c[3] = 0
        #print(c)
        #exit()
        #self.__renderer.SetBackground(c)
    ...
    def __create_single_cell(self, x_coord: int, y_coord: int):
        ...
        actor.GetProperty().SetColor(self.__colors.GetColor3d(self.__grid_color))
